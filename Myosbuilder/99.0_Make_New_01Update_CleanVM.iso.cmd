...
rd /q "%CP%\01_Syspreping\01Update_CleanVM.iso"

copy /y "%CP%\zzzzz_How_To_Use.txt" "%CP%\01_Syspreping\01Update_CleanVM"

%ToolsPath%\oscdimg.exe -o -l"01Update_CleanVM" -h -m -u2 "%CP%\01_Syspreping\01Update_CleanVM" "%CP%\01_Syspreping\01Update_CleanVM.iso"
