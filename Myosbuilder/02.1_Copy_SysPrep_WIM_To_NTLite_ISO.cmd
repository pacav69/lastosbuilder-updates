...
echo.
rem pause
echo Copying "%CP%\%SysPrepISOPath%\sources\%WIMName%" "%CP%\%NTLiteISOPath%\sources\%WIMName%"
copy /Y "%CP%\%SysPrepISOPath%\sources\%WIMName%" "%CP%\%NTLiteISOPath%\sources\%WIMName%"
